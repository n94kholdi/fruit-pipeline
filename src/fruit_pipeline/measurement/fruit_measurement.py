...
def measure_fruit_mask(
    ...
    contour_mm = contour_to_pallet_mm(contour_px, calibration, homography).astype(np.float32)
    ...
    return FruitMeasurement(
        fruit_id=int(fruit_id), width_mm=width, length_mm=length, area_mm2=area,
