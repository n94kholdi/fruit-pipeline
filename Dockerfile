...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    FRUIT_PIPELINE_SAM_TORCH_COMPILE=false \
    FRUIT_PIPELINE_SAM_SDPA_ATTENTION=false \
    FRUIT_PIPELINE_TRACKING_ENABLED=false \
    FRUIT_PIPELINE_SAM_REFRESH_INTERVAL=30 \
    FRUIT_PIPELINE_TRACKER_TYPE=optical_flow \
